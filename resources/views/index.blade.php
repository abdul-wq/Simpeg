@extends('compro_temp.temp')

<html class="no-js" lang="zxx">
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title> @section('title', 'Selamat Datang Pak!') </title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">

   @section('compro_temp.css')
...
<body>
    <!--[if lte IE 9]>
        ...
        <![endif]-->
@section('compro_temp.header')

@section('compro_temp.konten')
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-6 col-md-8">
                            <div class="slider_text">
                                <span></span>
                                <h3>Semua Ada Disisni Pak!</h3>
                                    <p>Lorem ipsum bla bla blas</p>
                ...
                <div class="col-lg-8">
                    <div class="certificate_listing d-flex justify-content-between align-items-center">
                        <div class="single_list">
                            <div class="thumb">
                                <img src="{{asset('hus/img/certificates/1.png')}}" alt="">
                            </div>
                        </div>
                        <div class="single_list">
                            <div class="thumb">
                                <img src="{{asset('hus/img/certificates/2.png')}}" alt="">
                            </div>
                        </div>
                        <div class="single_list">
                            <div class="thumb">
                                <img src="{{asset('hus/img/certificates/3.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="news_active owl-carousel">
                        <div class="single_news">
                            <div class="thumb">
                                <a href="#">
                                    <img src="{{asset('hus/img/news/1.png')}}" alt="">
                                </a>
                            </div>
                        ...
                        <div class="single_news">
                            <div class="thumb">
                                <a href="#">
                                    <img src="{{asset('hus/img/news/2.png')}}" alt="">
                                </a>
                            </div>
                            <div class="news_info d-flex">
                                <div class="date">
